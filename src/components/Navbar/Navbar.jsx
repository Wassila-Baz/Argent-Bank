...
import { useSelector, useDispatch } from 'react-redux'; // Importe useDispatch depuis react-redux
import "../Navbar/Navbar.css";
import logo from "../../assets/argentBankLogo.webp";
import { logoutUser } from '../../action/user.action'; // Importe l'action logoutUser
